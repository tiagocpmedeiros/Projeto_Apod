function buscar() {
    const API_KEY = "onGJecyKMkj6MZVg4JVsTk3CXDrzDmpYeWIvRseO";
    const data = $("#data").val();
    ...
    $.ajax({
      ...
      error: function() {
        $(".alert").html("Insira uma data entre 16 de junho de 1995 até a data atual <br> (exceto 17, 18 e 19 de junho de 1995).").css({color: "red", fontSize: "15px", paddingTop: "10px", fontWeight: "700"});
      }
    })
